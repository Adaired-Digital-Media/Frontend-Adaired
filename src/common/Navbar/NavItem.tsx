...
// const NavItem = ({ index, activeIndex, navitems }: NavItemProps) => {
//   const [megaMenuClicked, setMegaMenuClicked] = useState(false);
//   const [menuClicked, setMenuClicked] = useState(false);
//   const menuRef = useRef<HTMLDivElement>(null);

//   const handleClickOutside = (event: MouseEvent) => {
//     if (menuRef.current && !menuRef.current.contains(event.target as Node)) {
//       setMegaMenuClicked(false);
...
//   useEffect(() => {
//     if (megaMenuClicked || menuClicked) {
...
//         onClick={(event) => {
//           activeIndex();
//           navitems.subItems && event.preventDefault();
//           setMegaMenuClicked(!megaMenuClicked);
//           navitems.childrens && event.preventDefault();
...
//         <div
//           className={cn(
//             `absolute top-full text-sm inset-x-0 bg-white rounded-b-lg shadow-lg transition-all duration-300 origin-top scale-y-0 pointer-events-none p-4`,
//             megaMenuClicked ? "scale-y-100 pointer-events-auto" : ""
//           )}
//         >
...
//         <div
//           className={cn(
//             `min-w-40 absolute top-full bg-white p-4 rounded-b-lg shadow-lg transition-all duration-300 origin-top scale-y-0 pointer-events-none`,
//             menuClicked ? "scale-y-100 pointer-events-auto" : ""
//           )}
//         >
//           {navitems.childrens.map((children) => (
//             <div key={children.name} className="text-base sm:text-sm">
//               <Link
//                 href={children.href}
//                 className="block font-medium text-gray-900 py-2 hover:text-[#fb9100] transition-all duration-300"
//                 onClick={() => {
//                   setMenuClicked(false);
//                 }}
//               >
